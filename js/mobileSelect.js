...
(function() {
	...
	MobileSelect.prototype = {
		...
		init: function(config){
			...
			_this.checkDataType();
			_this.renderWheels(_this.wheelsData, config.cancelBtnText, config.ensureBtnText, config.isReset);
			...
			if (_this.cancelBtn.innerHTML == "关闭") {
				return;
			} else{
		...
		renderWheels: function(wheelsData, cancelBtnText, ensureBtnText, isReset){
			var _this = this;
